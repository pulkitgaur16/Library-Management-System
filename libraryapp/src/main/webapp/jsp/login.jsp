...
<link rel="stylesheet" href="/libraryapp/assets/css/common.css">
<link rel="stylesheet" href="/libraryapp/assets/css/auth.css">
</head>
...
<div class="login-container">
    <div class="login-card">
        <div class="login-header">
            ...
            <h3 class="login-title">Hello, Reader!</h3>
        ...
        <form action="/libraryapp/AuthenticationController" method="post">
